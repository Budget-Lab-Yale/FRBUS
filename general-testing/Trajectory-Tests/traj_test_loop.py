...
#log_file_path = '/gpfs/gibbs/project/sarin/jmk263/Repositories/FRBUS/src/error_log.txt'
#logging.basicConfig(filename=log_file_path, level=logging.ERROR, format='%(asctime)s - %(levelname)s - %(message)s')

personal = corporate = numpy.array([0,1,2,5])

for y in numpy.arange(start=6, stop=21):
        for j in corporate:
                for i in personal:
                        ...
                        try:
                                ...
                                run = f"{end_long},{-1*delta_pers},{-1*delta_corp},-1,0,0 \n"
                        ...
                        ########################### STEP 3: Specify trajectory variables ########################## 
                                ...
                                try:
                                        ...
                                        run = f"{end_long},{-1*delta_pers},{-1*delta_corp},1,{runtime},{last_surp} \n"
                                        with open('outcome_vars.csv', 'a') as f:
                                                f.write(run)
